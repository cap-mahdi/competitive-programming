...
// Problem: Given a board of characters and a dictionary, find all the words that can be formed on the board.
// You can move in 8 directions from a cell.
...
// Dictionary: SNAKE, FOR, QUEZ, SNACK, SNACKS, GO, TUNES, CAT

// Output: SNAKE, SNACK, SNACKS, CAT

// Approach:
// 1. Create a trie of all the words in the dictionary.
